// Code generated by goyacc -l -o query_parser.go query_parser.y. DO NOT EDIT.
package search
...
yydefault:
	...
	case 1:
		...
		{
			setResult(yylex, yyDollar[1].boolean)
		}
	case 3:
		yyDollar = yyS[yypt-2 : yypt+1]
		{
			yyVAL.boolean = mergeBoolean(yyDollar[1].boolean, yyDollar[2].boolean)
		}
	case 4:
		yyDollar = yyS[yypt-1 : yypt+1]
		{
			yyVAL.boolean = query.NewBooleanQueryForQueryString(nil, []query.Query{yyDollar[1].query}, nil)
		}
	case 5:
		yyDollar = yyS[yypt-2 : yypt+1]
		{
			yyVAL.boolean = query.NewBooleanQueryForQueryString([]query.Query{yyDollar[2].query}, nil, nil)
		}
	case 6:
		yyDollar = yyS[yypt-2 : yypt+1]
		{
			yyVAL.boolean = query.NewBooleanQueryForQueryString(nil, nil, []query.Query{yyDollar[2].query})
		}
	case 7:
		yyDollar = yyS[yypt-1 : yypt+1]
		{
	...
	case 8:
		...
		{
			yyVAL.query = setField(yyDollar[3].query, yyDollar[1].term)
		}
	case 9:
		yyDollar = yyS[yypt-2 : yypt+1]
		{
			yyVAL.query = setField(query.NewMatchQuery(yyDollar[2].term), "tags")
		}
	case 10:
		yyDollar = yyS[yypt-1 : yypt+1]
		{
